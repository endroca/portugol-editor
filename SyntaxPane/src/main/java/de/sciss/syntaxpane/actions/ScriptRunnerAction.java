    ...
    public void actionPerformed(JTextComponent target, SyntaxDocument sDoc,
        ...
        try {
            ...
            JOptionPane.showMessageDialog(SwingUtilities.getWindowAncestor(target),
                    java.util.ResourceBundle.getBundle("de/sciss/syntaxpane/Bundle").getString("ScriptRunnerAction.ErrorExecutingScript") + ex.getMessage(),
                    java.util.ResourceBundle.getBundle("de/sciss/syntaxpane/Bundle").getString("ScriptRunnerAction.ScriptError"),
    ...
    private ScriptEngine getEngine(JTextComponent target) {
        ...
        if (engine == null) {
            int result = JOptionPane.showOptionDialog(target,
                    MessageFormat.format(java.util.ResourceBundle.getBundle("de/sciss/syntaxpane/Bundle").getString("ScriptRunnerAction.ScriptEngineNotFound"), scriptExtension),
                    "syntaxpane",
