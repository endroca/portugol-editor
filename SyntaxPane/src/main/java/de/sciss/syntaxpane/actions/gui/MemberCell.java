...
class MethodCell extends MemberCell {
    ...
    public static final String METHOD_ICON_LOC = "de/sciss/syntaxpane/images/completions/method";
}
...
class ConstructorCell extends MemberCell {
    ...
    private static Map<Integer, Image> icons = null;
    public static final String FIELD_ICON_LOC = "de/sciss/syntaxpane/images/completions/constructor";
}